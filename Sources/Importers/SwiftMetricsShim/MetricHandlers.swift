...
class SwiftCounterMetric: CounterHandler, SwiftMetric {
  ...
  required init(name: String,
                ...
                meter: any PraiaOpenTelemetryApi.Meter) {
    metricName = name
...
class SwiftHistogramMetric: RecorderHandler, SwiftMetric {
  ...
  required init(name: String, labels: [String: String], meter: any PraiaOpenTelemetryApi.Meter) {
    metricName = name
...
protocol SwiftMetric {
  ...
  init(name: String, labels: [String: String], meter: any PraiaOpenTelemetryApi.Meter)
}
